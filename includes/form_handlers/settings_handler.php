...
if(isset($_POST['update_details'])) {
	...
	if($matched_user == "" || $matched_user == $userLoggedIn) {
		...
		$message = "That email already exists!<br><br>";
}
else 
	$message = "";
	...
	if(md5($old_password) == $db_password) {
		...
		if($new_password_1 == $new_password_2) {
			...
			if(strlen($new_password_1) <= 3) {
				$password_message = "Sorry, your password must be greater than 3 characters<br><br>";
			}	
			else {
			...
			$password_message = "The password is incorrect! <br><br>";
	}
